...
class TestStorageObject:
    ...
    def test_method_list_objects(self, client: Raindrop) -> None:
        storage_object = client.storage_object.list_objects(
            bucket_name="bucket_name",
        )
        assert_matches_type(StorageObjectListObjectsResponse, storage_object, path=["response"])
    ...
    def test_raw_response_list_objects(self, client: Raindrop) -> None:
        response = client.storage_object.with_raw_response.list_objects(
            bucket_name="bucket_name",
        )
    ...
    def test_streaming_response_list_objects(self, client: Raindrop) -> None:
        with client.storage_object.with_streaming_response.list_objects(
            bucket_name="bucket_name",
        ) as response:
    ...
    def test_path_params_list_objects(self, client: Raindrop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bucket_name` but received ''"):
            client.storage_object.with_raw_response.list_objects(
                bucket_name="",
            )
    ...
    def test_method_put_object(self, client: Raindrop) -> None:
        storage_object = client.storage_object.put_object(
            object_key="object_key",
            bucket_name="bucket_name",
            content="U3RhaW5sZXNzIHJvY2tz",
        )
        assert_matches_type(StorageObjectPutObjectResponse, storage_object, path=["response"])
    ...
    def test_raw_response_put_object(self, client: Raindrop) -> None:
        response = client.storage_object.with_raw_response.put_object(
            object_key="object_key",
            bucket_name="bucket_name",
            content="U3RhaW5sZXNzIHJvY2tz",
        )
    ...
    def test_streaming_response_put_object(self, client: Raindrop) -> None:
        with client.storage_object.with_streaming_response.put_object(
            object_key="object_key",
            bucket_name="bucket_name",
            content="U3RhaW5sZXNzIHJvY2tz",
        ) as response:
    ...
    def test_path_params_put_object(self, client: Raindrop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bucket_name` but received ''"):
            client.storage_object.with_raw_response.put_object(
                object_key="object_key",
                bucket_name="",
                content="U3RhaW5sZXNzIHJvY2tz",
            )
    ...
    def test_method_retrieve_object(self, client: Raindrop) -> None:
        storage_object = client.storage_object.retrieve_object(
            object_key="object_key",
            bucket_name="bucket_name",
        )
        assert_matches_type(StorageObjectRetrieveObjectResponse, storage_object, path=["response"])
    ...
    def test_raw_response_retrieve_object(self, client: Raindrop) -> None:
        response = client.storage_object.with_raw_response.retrieve_object(
            object_key="object_key",
            bucket_name="bucket_name",
        )
    ...
    def test_streaming_response_retrieve_object(self, client: Raindrop) -> None:
        with client.storage_object.with_streaming_response.retrieve_object(
            object_key="object_key",
            bucket_name="bucket_name",
        ) as response:
            assert not response.is_closed
    ...
    def test_path_params_retrieve_object(self, client: Raindrop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bucket_name` but received ''"):
            client.storage_object.with_raw_response.retrieve_object(
                object_key="object_key",
                bucket_name="",
            )
...
class TestAsyncStorageObject:
    ...
    async def test_method_list_objects(self, async_client: AsyncRaindrop) -> None:
        storage_object = await async_client.storage_object.list_objects(
            bucket_name="bucket_name",
        )
        assert_matches_type(StorageObjectListObjectsResponse, storage_object, path=["response"])
    ...
    async def test_raw_response_list_objects(self, async_client: AsyncRaindrop) -> None:
        response = await async_client.storage_object.with_raw_response.list_objects(
            bucket_name="bucket_name",
        )
    ...
    async def test_streaming_response_list_objects(self, async_client: AsyncRaindrop) -> None:
        async with async_client.storage_object.with_streaming_response.list_objects(
            bucket_name="bucket_name",
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_path_params_list_objects(self, async_client: AsyncRaindrop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bucket_name` but received ''"):
            await async_client.storage_object.with_raw_response.list_objects(
                bucket_name="",
            )
    ...
    async def test_method_put_object(self, async_client: AsyncRaindrop) -> None:
        storage_object = await async_client.storage_object.put_object(
            object_key="object_key",
            bucket_name="bucket_name",
            content="U3RhaW5sZXNzIHJvY2tz",
        )
    ...
    async def test_raw_response_put_object(self, async_client: AsyncRaindrop) -> None:
        response = await async_client.storage_object.with_raw_response.put_object(
            object_key="object_key",
            bucket_name="bucket_name",
            content="U3RhaW5sZXNzIHJvY2tz",
        )
    ...
    async def test_streaming_response_put_object(self, async_client: AsyncRaindrop) -> None:
        async with async_client.storage_object.with_streaming_response.put_object(
            object_key="object_key",
            bucket_name="bucket_name",
            content="U3RhaW5sZXNzIHJvY2tz",
        ) as response:
    ...
    async def test_path_params_put_object(self, async_client: AsyncRaindrop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bucket_name` but received ''"):
            await async_client.storage_object.with_raw_response.put_object(
                object_key="object_key",
                bucket_name="",
                content="U3RhaW5sZXNzIHJvY2tz",
            )
    ...
    async def test_method_retrieve_object(self, async_client: AsyncRaindrop) -> None:
        storage_object = await async_client.storage_object.retrieve_object(
            object_key="object_key",
            bucket_name="bucket_name",
        )
        assert_matches_type(StorageObjectRetrieveObjectResponse, storage_object, path=["response"])
    ...
    async def test_raw_response_retrieve_object(self, async_client: AsyncRaindrop) -> None:
        response = await async_client.storage_object.with_raw_response.retrieve_object(
            object_key="object_key",
            bucket_name="bucket_name",
        )
    ...
    async def test_streaming_response_retrieve_object(self, async_client: AsyncRaindrop) -> None:
        async with async_client.storage_object.with_streaming_response.retrieve_object(
            object_key="object_key",
            bucket_name="bucket_name",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_retrieve_object(self, async_client: AsyncRaindrop) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `bucket_name` but received ''"):
            await async_client.storage_object.with_raw_response.retrieve_object(
                object_key="object_key",
                bucket_name="",
            )
